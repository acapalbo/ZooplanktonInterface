function net = setupNetworkAdaptedGoogle365DualInput(imageSize,numClasses)
net = dlnetwork;
tempNet = [
...
tempNet = depthConcatenationLayer(4,"Name","inception_3a-output");
net = addLayers(net,tempNet);
...
tempNet = depthConcatenationLayer(4,"Name","inception_4a-output");
net = addLayers(net,tempNet);
...
tempNet = depthConcatenationLayer(4,"Name","inception_4b-output");
net = addLayers(net,tempNet);
...
tempNet = depthConcatenationLayer(4,"Name","inception_4c-output");
net = addLayers(net,tempNet);
...
tempNet = depthConcatenationLayer(4,"Name","inception_4d-output");
net = addLayers(net,tempNet);
...
tempNet = depthConcatenationLayer(4,"Name","inception_5a-output");
net = addLayers(net,tempNet);
...
tempNet = [
    ...
    fullyConnectedLayer(100,"Name","loss3-classifier")
    flattenLayer("Name","flatten")];
net = addLayers(net,tempNet);

tempNet = featureInputLayer(2,"Name","featureinput");
net = addLayers(net,tempNet);
...
clear tempNet;
% clean up helper variable
net = connectLayers(net,"pool2-3x3_s2","inception_3a-1x1");
net = connectLayers(net,"pool2-3x3_s2","inception_3a-3x3_reduce");
net = connectLayers(net,"pool2-3x3_s2","inception_3a-5x5_reduce");
net = connectLayers(net,"pool2-3x3_s2","inception_3a-pool");
net = connectLayers(net,"inception_3a-relu_1x1","inception_3a-output/in1");
net = connectLayers(net,"inception_3a-relu_3x3","inception_3a-output/in2");
net = connectLayers(net,"inception_3a-relu_5x5","inception_3a-output/in3");
net = connectLayers(net,"inception_3a-relu_pool_proj","inception_3a-output/in4");
net = connectLayers(net,"inception_3a-output","inception_3b-1x1");
net = connectLayers(net,"inception_3a-output","inception_3b-3x3_reduce");
net = connectLayers(net,"inception_3a-output","inception_3b-5x5_reduce");
net = connectLayers(net,"inception_3a-output","inception_3b-pool");
net = connectLayers(net,"inception_3b-relu_1x1","inception_3b-output/in1");
net = connectLayers(net,"inception_3b-relu_3x3","inception_3b-output/in2");
net = connectLayers(net,"inception_3b-relu_5x5","inception_3b-output/in3");
net = connectLayers(net,"inception_3b-relu_pool_proj","inception_3b-output/in4");
net = connectLayers(net,"pool3-3x3_s2","inception_4a-1x1");
net = connectLayers(net,"pool3-3x3_s2","inception_4a-3x3_reduce");
net = connectLayers(net,"pool3-3x3_s2","inception_4a-5x5_reduce");
net = connectLayers(net,"pool3-3x3_s2","inception_4a-pool");
net = connectLayers(net,"inception_4a-relu_1x1","inception_4a-output/in1");
net = connectLayers(net,"inception_4a-relu_3x3","inception_4a-output/in2");
net = connectLayers(net,"inception_4a-relu_5x5","inception_4a-output/in3");
net = connectLayers(net,"inception_4a-relu_pool_proj","inception_4a-output/in4");
net = connectLayers(net,"inception_4a-output","inception_4b-1x1");
net = connectLayers(net,"inception_4a-output","inception_4b-3x3_reduce");
net = connectLayers(net,"inception_4a-output","inception_4b-5x5_reduce");
net = connectLayers(net,"inception_4a-output","inception_4b-pool");
net = connectLayers(net,"inception_4b-relu_1x1","inception_4b-output/in1");
net = connectLayers(net,"inception_4b-relu_3x3","inception_4b-output/in2");
net = connectLayers(net,"inception_4b-relu_5x5","inception_4b-output/in3");
net = connectLayers(net,"inception_4b-relu_pool_proj","inception_4b-output/in4");
net = connectLayers(net,"inception_4b-output","inception_4c-1x1");
net = connectLayers(net,"inception_4b-output","inception_4c-3x3_reduce");
net = connectLayers(net,"inception_4b-output","inception_4c-5x5_reduce");
net = connectLayers(net,"inception_4b-output","inception_4c-pool");
net = connectLayers(net,"inception_4c-relu_1x1","inception_4c-output/in1");
net = connectLayers(net,"inception_4c-relu_3x3","inception_4c-output/in2");
net = connectLayers(net,"inception_4c-relu_5x5","inception_4c-output/in3");
net = connectLayers(net,"inception_4c-relu_pool_proj","inception_4c-output/in4");
net = connectLayers(net,"inception_4c-output","inception_4d-1x1");
net = connectLayers(net,"inception_4c-output","inception_4d-3x3_reduce");
net = connectLayers(net,"inception_4c-output","inception_4d-5x5_reduce");
net = connectLayers(net,"inception_4c-output","inception_4d-pool");
net = connectLayers(net,"inception_4d-relu_1x1","inception_4d-output/in1");
net = connectLayers(net,"inception_4d-relu_3x3","inception_4d-output/in2");
net = connectLayers(net,"inception_4d-relu_5x5","inception_4d-output/in3");
net = connectLayers(net,"inception_4d-relu_pool_proj","inception_4d-output/in4");
net = connectLayers(net,"inception_4d-output","inception_4e-1x1");
net = connectLayers(net,"inception_4d-output","inception_4e-3x3_reduce");
net = connectLayers(net,"inception_4d-output","inception_4e-5x5_reduce");
net = connectLayers(net,"inception_4d-output","inception_4e-pool");
net = connectLayers(net,"inception_4e-relu_1x1","inception_4e-output/in1");
net = connectLayers(net,"inception_4e-relu_3x3","inception_4e-output/in2");
net = connectLayers(net,"inception_4e-relu_5x5","inception_4e-output/in3");
net = connectLayers(net,"inception_4e-relu_pool_proj","inception_4e-output/in4");
net = connectLayers(net,"pool4-3x3_s2","inception_5a-1x1");
net = connectLayers(net,"pool4-3x3_s2","inception_5a-3x3_reduce");
net = connectLayers(net,"pool4-3x3_s2","inception_5a-5x5_reduce");
net = connectLayers(net,"pool4-3x3_s2","inception_5a-pool");
net = connectLayers(net,"inception_5a-relu_1x1","inception_5a-output/in1");
net = connectLayers(net,"inception_5a-relu_3x3","inception_5a-output/in2");
net = connectLayers(net,"inception_5a-relu_5x5","inception_5a-output/in3");
net = connectLayers(net,"inception_5a-relu_pool_proj","inception_5a-output/in4");
net = connectLayers(net,"inception_5a-output","inception_5b-1x1");
net = connectLayers(net,"inception_5a-output","inception_5b-3x3_reduce");
net = connectLayers(net,"inception_5a-output","inception_5b-5x5_reduce");
net = connectLayers(net,"inception_5a-output","inception_5b-pool");
net = connectLayers(net,"inception_5b-relu_1x1","inception_5b-output/in1");
...
net = connectLayers(net,"flatten","concat/in1");
net = connectLayers(net,"featureinput","concat/in2");
net = initialize(net);
end