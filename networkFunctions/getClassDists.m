function classCounts = getClassDists(vid,BWthresh,h_vars,videoPath,saveTrashImages,minLength,minWidth,outputDir,netTable,parallelPool)
    ...
    [tempImgKey,tempUniform] = prepareDatasetSingleClass(outputDir,fullfile(outputDir,"CleanDataset"),[229,229],videoTitle);
    
    classCounts = classifySegmentedImagesIsotonic(netTable,fullfile(outputDir,"CleanDataset"),tempUniform,0.7,outputDir,videoTitle,tempImgKey);
