function net = setupNetworkAdaptedDarkNetDualInput(imgSize,numClasses)
net = dlnetwork;
...
tempNet = [
    ...
    convolution2dLayer([1 1],512,"Name","conv53","Padding","same")
...
net = connectLayers(net,"softmax_flatten","concat/in2");
