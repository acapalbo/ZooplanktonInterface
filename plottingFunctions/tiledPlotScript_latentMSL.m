...
nicheOutputs = "D:\ZooPlanktonOutputs\BatchProcess_niche(44)";
% ,...
...
% nicheData = radiolarianDensities(1:581);
...
binnedNicheMSL = (binnedNiche.*1.150e+11)./1000;
larvaceanData = densityData(:,end);
...
a = area(allTimes,binnedNicheMSL+binnedLarvacean);
% a.FaceAlpha = 0.7;
% a.EdgeColor = "none";
a.EdgeAlpha = 0.3;
hold on
a = area(allTimes,binnedNicheMSL);
% a.FaceAlpha = 0.7;
% a.EdgeColor = "none";
a.EdgeAlpha = 0.3;

legend(["Oikopleura Contribution","Collodaria Contribution"])
xlim([allTimes(1),allTimes(end)])
ylim([0,15e7])
