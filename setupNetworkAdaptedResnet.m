function net = setupNetworkAdaptedResnet(imageInputSize,classOutputCount)
net = layerGraph();
...
tempNet = [
    ...
    fullyConnectedLayer(classOutputCount,"Name","fc1000","BiasLearnRateFactor",0)
...
net = connectLayers(net,"max_pooling2d_1","res2a_branch2a");
net = connectLayers(net,"max_pooling2d_1","res2a_branch1");
net = connectLayers(net,"bn2a_branch2c","add_1/in1");
net = connectLayers(net,"bn2a_branch1","add_1/in2");
net = connectLayers(net,"activation_4_relu","res2b_branch2a");
net = connectLayers(net,"activation_4_relu","add_2/in2");
net = connectLayers(net,"bn2b_branch2c","add_2/in1");
net = connectLayers(net,"activation_7_relu","res2c_branch2a");
net = connectLayers(net,"activation_7_relu","add_3/in2");
net = connectLayers(net,"bn2c_branch2c","add_3/in1");
net = connectLayers(net,"activation_10_relu","res3a_branch2a");
net = connectLayers(net,"activation_10_relu","res3a_branch1");
net = connectLayers(net,"bn3a_branch2c","add_4/in1");
net = connectLayers(net,"bn3a_branch1","add_4/in2");
net = connectLayers(net,"activation_13_relu","res3b_branch2a");
net = connectLayers(net,"activation_13_relu","add_5/in2");
net = connectLayers(net,"bn3b_branch2c","add_5/in1");
net = connectLayers(net,"activation_16_relu","res3c_branch2a");
net = connectLayers(net,"activation_16_relu","add_6/in2");
net = connectLayers(net,"bn3c_branch2c","add_6/in1");
net = connectLayers(net,"activation_19_relu","res3d_branch2a");
net = connectLayers(net,"activation_19_relu","add_7/in2");
net = connectLayers(net,"bn3d_branch2c","add_7/in1");
net = connectLayers(net,"activation_22_relu","res4a_branch2a");
net = connectLayers(net,"activation_22_relu","res4a_branch1");
net = connectLayers(net,"bn4a_branch2c","add_8/in1");
net = connectLayers(net,"bn4a_branch1","add_8/in2");
net = connectLayers(net,"activation_25_relu","res4b_branch2a");
net = connectLayers(net,"activation_25_relu","add_9/in2");
net = connectLayers(net,"bn4b_branch2c","add_9/in1");
net = connectLayers(net,"activation_28_relu","res4c_branch2a");
net = connectLayers(net,"activation_28_relu","add_10/in2");
net = connectLayers(net,"bn4c_branch2c","add_10/in1");
net = connectLayers(net,"activation_31_relu","res4d_branch2a");
net = connectLayers(net,"activation_31_relu","add_11/in2");
net = connectLayers(net,"bn4d_branch2c","add_11/in1");
net = connectLayers(net,"activation_34_relu","res4e_branch2a");
net = connectLayers(net,"activation_34_relu","add_12/in2");
net = connectLayers(net,"bn4e_branch2c","add_12/in1");
net = connectLayers(net,"activation_37_relu","res4f_branch2a");
net = connectLayers(net,"activation_37_relu","add_13/in2");
net = connectLayers(net,"bn4f_branch2c","add_13/in1");
net = connectLayers(net,"activation_40_relu","res5a_branch2a");
net = connectLayers(net,"activation_40_relu","res5a_branch1");
net = connectLayers(net,"bn5a_branch2c","add_14/in1");
net = connectLayers(net,"bn5a_branch1","add_14/in2");
net = connectLayers(net,"activation_43_relu","res5b_branch2a");
net = connectLayers(net,"activation_43_relu","add_15/in2");
net = connectLayers(net,"bn5b_branch2c","add_15/in1");
net = connectLayers(net,"activation_46_relu","res5c_branch2a");
net = connectLayers(net,"activation_46_relu","add_16/in2");
net = connectLayers(net,"bn5c_branch2c","add_16/in1");
net = dlnetwork(net);