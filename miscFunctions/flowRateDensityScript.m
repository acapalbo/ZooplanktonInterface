...
videoDirPath = "E:\202402XX_LUMEX1\PID\2024-03-03 11-07-05.392";
...
outputTable = [];
%% Begin Algorithm
allTimes = getVidTimes(videoDirPath);
...
% end
    ...
    outputTable = repmat(outputTable,length(dirPath)-2,1);
    ...
    for z = 3:length(dirPath)
        ...
        outputTable(z-2) = struct("Filename",fullfile(videoDirPath,file),"NumFrames",numFrames,"Counts",classCounts,"LitersProcessed",liters,"Densities",densities);
